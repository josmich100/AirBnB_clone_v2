...
class DBStorage:
    ...
    def __init__(self):
        ...
        if getenv("HBNB_ENV") == "test":
            # Use declarative_base instead of Base.metadata.drop_all for better code organization
    ...
    def all(self, cls=None):
        ...
        if cls is None:
            ...
            objs = self.__session.query(cls) if isinstance(cls, type) else self.__session.query(eval(cls))
    ...
    def reload(self):
        ...
        # Use declarative_base instead of Base.metadata.create_all for better code organization
